        ...
        context 'when a one to one is declared' do
          context 'when missing dependencies' do
            it 'throws with a non existent fk' do
              ...
              end.to raise_error(ForestAdminDatasourceToolkit::Exceptions::NotFoundError, "Column not found: 'passport.__nonExisting__'")
            end
          end
          ...
          context 'when missing operators' do
            it 'throws when In is not supported by the fk in the target' do
              ...
              end.to raise_error(ForestAdminDatasourceToolkit::Exceptions::UnprocessableError, "Column does not support the In operator: 'passport.picture_id'")
            end
          end
          ...
          it 'throws when there is a given originKeyTarget that does not match the target type' do
            ...
            end.to raise_error(ForestAdminDatasourceToolkit::Exceptions::UnprocessableError, "Types from 'passport.owner_id' and 'person.name' do not match.")
          end
        ...
        context 'when a many to one is declared' do
          context 'when missing dependencies' do
            it 'throws with a non existent collection' do
              ...
              end.to raise_error(ForestAdminDatasourceToolkit::Exceptions::NotFoundError, 'Collection __nonExisting__ not found.')
            end
