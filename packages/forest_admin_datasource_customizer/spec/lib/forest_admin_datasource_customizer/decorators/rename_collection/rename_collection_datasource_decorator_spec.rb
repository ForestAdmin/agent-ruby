        ...
        context 'with ManyToMany relation' do
          ...
          describe 'rename_collection' do
            ...
            it 'raise an error if the given old name does not exist' do
              ...
              end.to raise_error(ForestAdminDatasourceToolkit::Exceptions::ForestException, 'Collection doesNotExist not found.')
            end
          ...
          describe 'rename_collections' do
            ...
            it 'raise an error if the argument is not a function or a hash' do
              ...
              end.to raise_error(ForestAdminAgent::Http::Exceptions::BadRequestError, 'Invalid argument for rename_collections, must be a function or a hash')
            end
          end
        end
