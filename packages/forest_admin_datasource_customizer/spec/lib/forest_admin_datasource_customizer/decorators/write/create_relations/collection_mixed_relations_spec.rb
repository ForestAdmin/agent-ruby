      ...
      module WriteReplace
        ...
        describe WriteDatasourceDecorator do
            ...
            @collection_book = instance_double(
              ...
              schema: {
                fields: {
                  ...
                  'title' => column_build,
                  'my_author' => one_to_one_build(foreign_collection: 'author', origin_key: 'id'),
          ...
          it 'creates the relations and attaches to the new collection' do
            ...
            expect(@collection_author).to have_received(:create).with(caller, { 'id' => '123e4567-e89b-12d3-a456-426614174087', 'name' => 'Orius' })
