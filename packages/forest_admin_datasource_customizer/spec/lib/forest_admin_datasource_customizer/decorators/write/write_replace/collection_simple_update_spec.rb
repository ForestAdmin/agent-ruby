      ...
      module WriteReplace
        ...
        describe WriteReplaceCollectionDecorator do
          ...
          it 'raises an error when two handlers request conflicting updates' do
            ...
            expect { @decorated_book.update(caller, filter, { 'name' => 'a name', 'age' => 'an age' }) }.to raise_error(ForestAdminAgent::Http::Exceptions::ConflictError, 'Conflict value on the field price. It received several values.')
          end
          ...
          it 'throws when handlers call themselves recursively' do
            ...
            expect { @decorated_book.update(caller, filter, { 'name' => 'a name' }) }.to raise_error(ForestAdminAgent::Http::Exceptions::ConflictError, 'Conflict value on the field name. It received several values.')
          end
          ...
          it 'throws when the handler returns a unexpected type' do
            ...
            expect { @decorated_book.update(caller, filter, { 'age' => '10' }) }.to raise_error(ForestAdminAgent::Http::Exceptions::UnprocessableError, 'The write handler of age should return an Hash or nothing.')
          end
          ...
          it 'throws when the handler returns non existent fields' do
            ...
            expect { @decorated_book.update(caller, filter, { 'age' => '10' }) }.to raise_error(ForestAdminAgent::Http::Exceptions::NotFoundError, "Unknown field: 'author'")
          end
