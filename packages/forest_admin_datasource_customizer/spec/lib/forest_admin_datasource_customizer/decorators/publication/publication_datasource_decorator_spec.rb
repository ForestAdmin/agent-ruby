      ...
      describe PublicationDatasourceDecorator do
        ...
        context 'when keep_collections_matching is called' do
          it 'throws an error if a name is unknown' do
            expect { @datasource_decorator.keep_collections_matching(['unknown']) }.to raise_error(ForestAdminDatasourceToolkit::Exceptions::ForestException, 'Collection unknown not found.')
            expect { @datasource_decorator.keep_collections_matching(nil, ['unknown']) }.to raise_error(ForestAdminDatasourceToolkit::Exceptions::ForestException, 'Collection unknown not found.')
          end
          ...
          it 'is able to remove "book" collection' do
            ...
            expect { @datasource_decorator.get_collection('book') }.to raise_error(ForestAdminAgent::Http::Exceptions::NotFoundError, "Collection 'book' was removed.")
