      ...
      describe ActionCollectionDecorator do
        ...
        describe 'add_action' do
          it 'raise an error if multiple fields with same id are provided' do
            ...
            end.to raise_error(ForestAdminAgent::Http::Exceptions::ConflictError, "All field must have different 'id'. Conflict come from field 'id'")
          end
          ...
          it 'raise an error if form mix form elements and pages' do
            ...
            expect do
              @decorated_book.add_action('make photocopy', action)
            end.to raise_error(ForestAdminAgent::Http::Exceptions::UnprocessableError, "You cannot mix pages and other form elements in smart action 'make photocopy' form")
          end
        end
      end
    end
