module ForestAdminDatasourceIntercom
  ...
  class RetryPolicy
    ...
    #
    # A 429 stays safe to retry on any verb, Intercom having rejected the
    # request before processing it, and travels through retry_if rather than
    # through this list: faraday-retry ORs the two, so `methods` can only widen
    # the set, never restrict it.
