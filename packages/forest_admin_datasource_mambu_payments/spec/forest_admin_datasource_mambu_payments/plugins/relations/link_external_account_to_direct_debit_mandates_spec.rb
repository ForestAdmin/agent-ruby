RSpec.describe ForestAdminDatasourceMambuPayments::Plugins::Relations::LinkExternalAccountToDirectDebitMandates do
  ...
  describe '#run' do
    it 'adds OneToMany direct_debit_mandates on MambuExternalAccount via external_account_id' do
      install
      rel = datasource_customizer.collections['MambuExternalAccount']
                                 .one_to_many_relations['direct_debit_mandates']
    ...
    it 'does not customize MambuDirectDebitMandate (FK already native)' do
      install
