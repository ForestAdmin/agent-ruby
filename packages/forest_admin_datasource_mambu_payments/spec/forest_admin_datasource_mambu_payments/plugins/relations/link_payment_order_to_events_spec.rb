RSpec.describe ForestAdminDatasourceMambuPayments::Plugins::Relations::LinkPaymentOrderToEvents do
  ...
  describe '#run' do
    it 'adds OneToMany events on MambuPaymentOrder via related_object_id' do
      install
      rel = datasource_customizer.collections['MambuPaymentOrder'].one_to_many_relations['events']
