...
module ForestAdminDatasourceGraphqlHasura
  ...
  class Client
    ...
    def execute(query, variables = {})
      ...
      raise GraphqlError, "GraphQL endpoint returned HTTP #{response.code}" unless response.is_a?(Net::HTTPSuccess)
      ...
      raise GraphqlError, "Could not reach the GraphQL endpoint (#{e.class}): #{e.message}"
    end
