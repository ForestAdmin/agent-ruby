  ...
  describe '#ticket_custom_fields' do
    it 'maps Zendesk types to Forest column types' do
      allow(client).to receive(:fetch_ticket_fields).and_return([
                                                                  { 'id' => 1, 'type' => 'text',     'active' => true,
                                                                    'removable' => true },
                                                                  { 'id' => 2, 'type' => 'integer',  'active' => true,
                                                                    'removable' => true },
                                                                  { 'id' => 3, 'type' => 'date',     'active' => true,
                                                                    'removable' => true },
                                                                  { 'id' => 4, 'type' => 'checkbox', 'active' => true,
                                                                    'removable' => true }
                                                                ])
